...
public class ClubSimulation {
   ...
   static PeopleCounter tallys; //counters for number of people inside and outside club
    ...
    static AtomicBoolean start = new AtomicBoolean(false); //atomic variable start flag as false
    static AtomicBoolean pause = new AtomicBoolean(false); //atomic variable pause flag as false
   ...
   public static void setupGUI(int frameX,int frameY,int [] exits) {
      ...
      startB.addActionListener(
         new ActionListener() {
            public void actionPerformed(ActionEvent e)  {
                ...
                start.set(true);//if start set true
                synchronized (ClubSimulation.class) {
                    ClubSimulation.class.notifyAll();//notify all threads
                }
                pause.set(false);//set pause to false
      ...
      pauseB.addActionListener(
         new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	// THIS DOES NOTHING - MUST BE FIXED  
              pause.set(true); //if paused set to true
    ...
    public static boolean isStarted() {//get start
        return start.get();
    }

    public static boolean isPaused() {//get pause
        return pause.get();
    }
